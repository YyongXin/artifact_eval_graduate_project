...
def resnet(units, num_stage, filter_list, num_class, data_type='imagenet', bottle_neck=True, bn_mom=0.9, workspace=512, memonger=False):
...
def resnet_with_depth(depth=50,num_classes=1000):
    if depth == 18:
        units = [2, 2, 2, 2]
    elif depth == 34:
        units = [3, 4, 6, 3]
